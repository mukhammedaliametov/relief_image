...
const Garden = () => {
  return (
    ...
    >
      ...
      <div className="z-10 max-w-[1220px] mx-auto px-[16px] lg:px-0">
        ...
        <p data-aos="fade-up" className="bg-[#39362FCC] p-[20px] text-caramel rounded-[5px] my-[20px] font-roboto font-[300] tracking-[1px] text-[14px]/[24px] md:text-[16px]/[26px] text-justify md:text-left">
        ...
        <div data-aos="fade-up" className="bg-white font-roboto w-full lg:w-[97%] mx-auto rounded-[5px] border border-[#00000040] shadow shadow-[#00000040] py-[15px] md:py-[30px] px-[20px]">
